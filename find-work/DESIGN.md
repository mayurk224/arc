...
## Mission
Create implementation-ready, token-driven UI guidance for Not Found that is optimized for consistency, accessibility, and fast delivery across dashboard web app.
...
- Include known page component density: links (25), buttons (17), lists (4), navigation (2), inputs (1).
